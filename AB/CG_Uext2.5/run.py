...
interactions[('A','B')]=[ {'type':'LJG','Label':'AB','B':0.43,'Kappa':0.25,'Dist0':0.,'Sigma':1.,'Epsilon':0.,'Cut':5., 'fixB':False} ]
interactions[('A')]=[ {'type':'external_sine','Label':'Uext','UConst':2.5,'NPeriods':1,'PlaneAxis':0,'PlaneLoc':0.} ]
...
#other inputs
datadir='.'
traj_file = os.path.abspath('{}/L30-15-15_du0_Uext2.5_200frames.lammpstrj'.format(datadir))
