...
interactions[('A','A')]=[ {'type':'LJG','Label':'AA','B':0.42495,'Kappa':0.25,'Dist0':0.,'Sigma':1.,'Epsilon':0.,'Cut':5., 'fixB':True} ]
interactions[('B','B')]=[ {'type':'LJG','Label':'BB','B':0.42495,'Kappa':0.25,'Dist0':0.,'Sigma':1.,'Epsilon':0.,'Cut':5., 'fixB':True} ]
interactions[('A','B')]=[ {'type':'LJG','Label':'AB','B':0.4474,'Kappa':0.25,'Dist0':0.,'Sigma':1.,'Epsilon':0.,'Cut':5., 'fixB':False} ]
interactions[('A')]=[ {'type':'external_sine','Label':'Uext','UConst':0.5,'NPeriods':1,'PlaneAxis':0,'PlaneLoc':0.} ]
...
#other inputs
datadir='.'
traj_file = os.path.abspath('{}/L30-15-15_du0_Uext0.5_200frames.lammpstrj'.format(datadir))
